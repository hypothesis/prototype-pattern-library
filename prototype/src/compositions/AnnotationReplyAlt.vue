<template>
  <section
    :class="[
      $options.name,
      'border__all color__border--base-light margin__bottom--m margin__left--m margin__right--m'
    ]"
  >
    <AnnotationIndicator icon="edit">
      <header
        :class="[
          $options.name + '__header',
          replyActive ? 'border__bottom color__border--base-light' : '',
          'padding__bottom--s padding__left--s padding__right--s padding__top--xs'
        ]"
      >
    ...
    <section
      v-if="replyActive"
      :class="[
        $options.name + '__footer--secondary',
        'border__top color__border--base-light padding__bottom--s padding__left--m padding__right--m padding__top--s'
      ]"
    >
      <CC />
    </section>
